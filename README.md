...
2. Клонирован локально командой: `git clone https://github.com/em0clown/C-Programming.git`
...
![Начальная настройка](image/image.png)
...
![Первый коммит](image/image-1.png)
...
```bash
echo "Колесов Георгий" > file1.txt
git add file1.txt
...
![Два состояния](image/image-3.png)
...
![Fast-forward](image/image-4.png)
...
![Результат слияния](image/image-6.png)
